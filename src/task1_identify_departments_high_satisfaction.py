...
def main():
    ...
    input_file = "/workspaces/spark-structured-api-employee-engagement-analysis-Navya-vejalla/input/employee_data.csv"
    output_file = "/workspaces/spark-structured-api-employee-engagement-analysis-Navya-vejalla/outputs/task1/departments_high_satisfaction.csv"
